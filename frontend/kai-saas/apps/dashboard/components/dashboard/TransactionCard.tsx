...
export default function TransactionCard({ variant }: TransactionCardProps) {
  if (variant === 'first') {
    return (
      <>
        ...
        <div className="w-20 h-5 left-[500.61px] top-[847.85px] absolute text-center justify-start text-neutral-900 text-xl font-bold font-['Nunito_Sans']">$85,66</div>
        <div className="w-20 h-3.5 left-[499.66px] top-[880.42px] absolute text-center justify-start text-zinc-400 text-sm font-normal font-['Nunito_Sans']">Expense</div>
        <div className="w-4 h-5 left-[331.29px] top-[1041.54px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">20</div>
        <div className="w-2.5 h-5 left-[339.52px] top-[1088.20px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">0</div>
        <div className="w-5 h-5 left-[330.26px] top-[997.52px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">40</div>
        <div className="w-5 h-5 left-[330.26px] top-[952.61px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">60</div>
        <div className="w-5 h-5 left-[330.26px] top-[907.71px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">80</div>
        <div className="w-6 h-5 left-[325.11px] top-[863.69px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">100</div>
        <div className="w-5 h-4 left-[318px] top-[818.79px] absolute bg-green-500 rounded-2xl" />
        <div className="w-40 h-4 left-[349.91px] top-[817.03px] absolute justify-start text-neutral-900 text-base font-semibold font-['Nunito_Sans']">Income</div>
        <div className="w-5 h-4 left-[427.17px] top-[819.67px] absolute bg-teal-500 rounded-2xl" />
        <div className="w-40 h-4 left-[459.08px] top-[817.03px] absolute justify-start text-neutral-900 text-base font-semibold font-['Nunito_Sans']">Expense</div>
        <div className="w-60 h-5 left-[312px] top-[777.41px] absolute justify-start text-neutral-900 text-lg font-bold font-['Nunito_Sans']">Transaction Overview</div>
      </>
    );
  }
  ...
  if (variant === 'second') {
    return (
      <>
        ...
        <div className="w-20 h-5 left-[868.54px] top-[847.85px] absolute text-center justify-start text-neutral-900 text-xl font-bold font-['Nunito_Sans']">$85,66</div>
        <div className="w-20 h-3.5 left-[867.59px] top-[880.42px] absolute text-center justify-start text-zinc-400 text-sm font-normal font-['Nunito_Sans']">Expense</div>
        <div className="w-4 h-5 left-[699.28px] top-[1041.54px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">20</div>
        <div className="w-2.5 h-5 left-[707.51px] top-[1088.20px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">0</div>
        <div className="w-5 h-5 left-[698.25px] top-[997.52px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">40</div>
        <div className="w-5 h-5 left-[698.25px] top-[952.61px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">60</div>
        <div className="w-5 h-5 left-[698.25px] top-[907.71px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">80</div>
        <div className="w-6 h-5 left-[693.10px] top-[863.69px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">100</div>
        <div className="w-5 h-4 left-[685.99px] top-[818.79px] absolute bg-kai-yellow rounded-2xl" />
        <div className="w-40 h-4 left-[717.89px] top-[817.03px] absolute justify-start text-neutral-900 text-base font-semibold font-['Nunito_Sans']">Income</div>
        <div className="w-5 h-4 left-[795.12px] top-[819.67px] absolute bg-blue-900 rounded-2xl" />
        <div className="w-40 h-4 left-[827.01px] top-[817.03px] absolute justify-start text-neutral-900 text-base font-semibold font-['Nunito_Sans']">Expense</div>
        <div className="w-60 h-5 left-[684.95px] top-[777.41px] absolute justify-start text-neutral-900 text-lg font-bold font-['Nunito_Sans']">Transaction Overview</div>
      </>
    );
  }
  ...
  return (
    <>
      ...
      <div className="w-20 h-5 left-[1236.89px] top-[847.85px] absolute text-center justify-start text-neutral-900 text-xl font-bold font-['Nunito_Sans']">$85,66</div>
      <div className="w-20 h-3.5 left-[1235.94px] top-[880.42px] absolute text-center justify-start text-zinc-400 text-sm font-normal font-['Nunito_Sans']">Expense</div>
      <div className="w-4 h-5 left-[1067.35px] top-[1041.54px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">20</div>
      <div className="w-2.5 h-5 left-[1075.59px] top-[1088.20px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">0</div>
      <div className="w-5 h-5 left-[1066.32px] top-[997.52px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">40</div>
      <div className="w-5 h-5 left-[1066.32px] top-[952.61px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">60</div>
      <div className="w-5 h-5 left-[1066.32px] top-[907.71px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">80</div>
      <div className="w-6 h-5 left-[1061.16px] top-[863.69px] absolute justify-start text-neutral-500 text-sm font-normal font-['Nunito_Sans']">100</div>
      <div className="w-5 h-4 left-[1054.04px] top-[818.79px] absolute bg-kai-blue rounded-2xl" />
      <div className="w-40 h-4 left-[1085.99px] top-[817.03px] absolute justify-start text-neutral-900 text-base font-semibold font-['Nunito_Sans']">Income</div>
      <div className="w-5 h-4 left-[1163.35px] top-[819.67px] absolute bg-blue-900 rounded-2xl" />
      <div className="w-40 h-4 left-[1195.30px] top-[817.03px] absolute justify-start text-neutral-900 text-base font-semibold font-['Nunito_Sans']">Expense</div>
      <div className="w-60 h-5 left-[1053.01px] top-[777.41px] absolute justify-start text-neutral-900 text-lg font-bold font-['Nunito_Sans']">Transaction Overview</div>
    </>
  );
}
