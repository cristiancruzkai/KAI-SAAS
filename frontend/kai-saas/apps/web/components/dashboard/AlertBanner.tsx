...
export function AlertBanner() {
  return (
    <div className="w-[1089px] h-48 relative">
      <img className="w-[1089px] h-48 left-0 top-0 absolute rounded-2xl" src="/kaiBanner.png" />
      <div className="w-72 h-12 left-[27px] top-[60px] absolute justify-start text-white text-2xl font-semibold font-['Inter']">Descubre el poder del nuevo panel web de kAI</div>
      <div className="w-24 h-3.5 left-[27px] top-[32px] absolute justify-start text-white text-sm font-normal font-['Nunito_Sans'] uppercase">Novedades</div>
