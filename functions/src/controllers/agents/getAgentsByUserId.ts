 ...
 */
export const getAgentsByUserId = async (req: Request, res: Response): Promise<any> => {
    try {
        ...
        const agentDraftsRef = db.collection('usersBuilders').doc(userId).collection('agentDrafts');
