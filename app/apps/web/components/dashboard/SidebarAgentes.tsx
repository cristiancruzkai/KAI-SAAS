...
export function Sidebar() {
  return (
    <div className="w-52 h-[790px] relative">
      ...
      <img className="w-28 h-28 left-[43px] top-[564px] absolute rounded-2xl" src="https://placehold.co/120x120" />
      ...
      <div className="w-32 h-12 left-[41px] top-[708px] absolute text-center justify-start text-neutral-800 text-base font-normal font-['Nunito_Sans'] leading-4">Escanea y genera tu Agente desde WhatsApp</div>
      ...
      <div className="w-36 h-16 left-[37px] top-[45px] absolute opacity-90 justify-start text-neutral-900/80 text-base font-light font-['Nunito_Sans'] leading-8">Editar Agente<br/>Tools<br/>Enviar recordatorios</div>
